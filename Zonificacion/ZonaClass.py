...
class zona:
    ...
    def __init__(self, **kwargs):
        ...
        self.Nombre = kwargs.get('Nombre', 'SN')        
        self.tipo = kwargs.get('tipo', 'cartesianas')    
        self.Xmin = kwargs.get('Xmin', 0)    
        self.Xmax = kwargs.get('Xmax', 0)    
        self.Ymin = kwargs.get('Ymin', 0)    
        self.Ymax = kwargs.get('Ymax', 0)    
        self.Zmin = kwargs.get('Zmin', 0)    
        self.Zmax = kwargs.get('Zmax', 0)    
        self.Rmin = kwargs.get('Rmin', 0)    
        self.Rmax = kwargs.get('Rmax', 0)    
        self.THETAmin = kwargs.get('THETAmin', 0)    
        self.THETAmax = kwargs.get('THETAmax', 0)    
        self.comp = pd.Index(kwargs.get('comp', []))
